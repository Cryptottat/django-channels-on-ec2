...
BASE_DIR = Path(__file__).resolve().parent.parent  # home/ubuntu/
...
MIDDLEWARE = [
    ...
    # "django.middleware.clickjacking.XFrameOptionsMiddleware",  # iframe 허용
]
...
# etc
LOGIN_REDIRECT_URL = 'https://nvrankup.monster/'
LOGOUT_REDIRECT_URL = 'https://nvrankup.monster/'
